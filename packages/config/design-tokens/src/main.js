...
module.exports = {
  color: {
    ...
    font: {
      base: {
        value: "#FF0000",
        filePath: "tokens/colors/font.json",
        isSource: true,
        original: {
